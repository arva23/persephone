...
public:
	...
	FDM1(genmath::Vector<T>* values, genmath::Vector<T>* coeffs, const T space_step,
		const T start_time, size_t num_of_fragments = 1);
...
template class FDM1<genmath::LongDouble>;
